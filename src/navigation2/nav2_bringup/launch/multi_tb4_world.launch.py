...
def generate_launch_description():
    ...
    for robot in robots:
        ...
        robot_group = GroupAction([
            ...
            Node(package='ros_gz_image', executable='image_bridge', namespace=namespace, arguments=['rgbd_camera/image']),
            Node(package='ros_gz_image', executable='image_bridge', namespace=namespace, arguments=['rgbd_camera/depth_image']),
        ])
